// Модель Airport описывает таблицу базы данных и связи, которые EF Core использует при чтении и сохранении данных.
...
public partial class Airport
{
    ...
    public virtual ICollection<DepartureStatus> DepartureStatusRedirectedAirports { get; set; } = new List<DepartureStatus>();
