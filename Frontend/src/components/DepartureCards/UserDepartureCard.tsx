                ...
                <div className="departure-header">
                    <div className="departure-route">
                        <div className="airport-block">
                            <span className="airport-code">{departure.takeOffAirport.split(' ')[0]}</span>
                            <span className="airport-label">Вылет</span>
                        </div>
                        <div className="route-path">
                            <div className="path-line"></div>
                            <svg className="plane-icon" viewBox="0 0 24 24"><path d="M21,16L21,14L13,9L13,3.5A1.5,1.5 0 0,0 11.5,2A1.5,1.5 0 0,0 10,3.5L10,9L2,14L2,16L10,13.5L10,18L8,19.5L8,21L11.5,20L15,21L15,19.5L13,18L13,13.5L21,16Z" /></svg>
                        </div>
                        <div className="airport-block">
                            <span className="airport-code">{departure.landingAirport.split(' ')[0]}</span>
                            <span className="airport-label">Прибытие</span>
                        </div>
                    </div>
                    
                    <div className="departure-status-block">
                        <span className={`status-badge ${departure.status.toLowerCase()}`}>
                            {departure.status}
                        </span>
