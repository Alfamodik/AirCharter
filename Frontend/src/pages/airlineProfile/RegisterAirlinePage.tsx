                    ...
                    <form onSubmit={handleSubmit} className="airline-profile-form">
                        ...
                        <section className="airline-profile-section">
                            ...
                            <div className="airline-profile-grid">
                                ...
                                <InputField label="Срок договора, дней" type="number" min="1" value={formData.contractValidityDays?.toString() ?? ""} onChange={(value) => updateField("contractValidityDays", value)} />
                                ...
                                <InputField label="Прибытие пассажиров, минут" type="number" min="1" value={formData.passengerArrivalMinutesBeforeFlight?.toString() ?? ""} onChange={(value) => updateField("passengerArrivalMinutesBeforeFlight", value)} />
